								...
								<tr>
									...
									<td>
										<select name="satuan" class="form-control">
											...
											<option value=" beras karisma"> beras karisma</option>
											<option value=" beras kepala "> beras kepala</option>
											<option value=" beras super"> beras super</option>
											<option value=" beras spesial"> beras spesial</option>
											<option value=" beras spesial"> beras ketan</option>
											<option value=" beras spesial"> beras lainnya</option>
										</select>
									</td>
								</tr>
								<tr>
