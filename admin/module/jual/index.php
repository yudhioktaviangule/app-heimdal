						...
						<div class="col-sm-4">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h4><i class="fa fa-search"></i> Cari Beras </h4>
								</div>
								<div class="panel-body">
									<input type="text" id="cari" class="form-control" name="cari" placeholder="Masukkan : Kode / Nama Beras  [ENTER]">
								</div>
							</div>
						</div>
						<div class="col-sm-8">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<?php $pelanggan = $lihat->pelanggan();?>
									<select required name="member_id" id="plg" class="form-control">
										...
										<table class="table table-bordered" id="example1">
											...
											<tbody>
												...
												<form method="POST" action="fungsi/edit/edit.php?jual=jual">
													...
													<td><?php echo $isi['nmpelanggan'];?></td>
													<td>
...
$(document).ready(function(){
	$("#cari").change(function(){
		orkes = $("#plg").val()
		if(orkes==""){
			alert("Data Pelanggan Jangan dikosongkan")
		}else{
			$.ajax({
				type: "POST",
				url: `fungsi/edit/edit.php?cari_barang=yes&pelanggan_id=${orkes}`,
