   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <?php echo date('Y');?> - Jl. Jendral Sudirman no.29 Makassar RT 005/014 No.29, Kota Makassar   
              <a href="https://duamasachannel.blogspot.com" style="font-weight:700;" target="_blank"></a>
              <a href="#" class="go-top">
